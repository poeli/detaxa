...
The goal of the project is to provide a Python-based package that is able to retrieve taxonomic information / lineage given a taxonomy ID or NCBI accession number. PyTaxa supports NCBI taxonomy, EBI MGnify lineage, and GTDB taxonomy. Users can also import custom taxonomy and lineages. The taxonomy files generated by [Krona](https://github.com/marbl/Krona) (Ondov et. al., 2011) are compatible with PyTaxa. Part of the codes are ported from Krona taxonomy tool written in Perl.
