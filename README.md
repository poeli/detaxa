...
DeTaxa will automatically convert following abbreviations to the full name of rank. These ranks are defined as major ranks but DeTaxa allows all ranks inclusing user defined ranks. Note that major ranks can be modified -- see [[here]](#levels_and_abbr)] for details.
